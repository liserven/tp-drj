...
/**
 * Connects to the AS/400 service.
 * @param service string name of the service to connect, can be either symbolic name or IP
...
/**
 * Persistent connection to the AS/400 service.
 ...
 * <li>The connection can be reused for another web request if the request contains the same service id, user and password used in the previous web request.</li>
...
/**
 * Close connection to AS/400 service.
 ...
 * @param description array[optional] PHP-format program description. This should be provided if the program is not described on service.
 * @param connection resource[optional] result of i5_connect
 ...
 * This function needs only to be called if your script requires too much memory, when a request returns very large results or if a large requests number are processed and may overload the web service memory. It is recommended to use this function to free memory resource used by SQL request. All memory resources are freed when the SQL request is ended.
