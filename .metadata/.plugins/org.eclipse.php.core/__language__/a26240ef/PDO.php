...
class PDO  {
	 ...
	 * This must be a valid SQL statement template for the target database service.
	 * </p>
	 ...
	 * prepare-time.
	 * </p>
	 * @return PDOStatement If the database service successfully prepares the statement,
	 * PDO::prepare returns a
	 * PDOStatement object.
	 * If the database service cannot successfully prepare the statement,
	 * PDO::prepare returns false or emits
	 * PDOException (depending on error handling).
	 * </p>
	 * <p>
	 * Emulated prepared statements does not communicate with the database service
...
class PDOStatement implements Traversable {
	 ...
	 * service to manipulate the result sets. For example, use the WHERE and
