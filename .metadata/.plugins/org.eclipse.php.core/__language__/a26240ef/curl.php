 ...
 * true to follow any
 * "Location: " header that the service sends as
 ...
 * more than one method. If this is done, cURL will poll the service to see
 ...
 * would be incorrect.
 * <p>
 * Don't do this without making sure the service supports the custom
 ...
 * the remote service to connect to our specified IP address. The
 ...
 * An array of FTP commands to execute on the service after the FTP
 ...
 * <tr valign="top">
 * CURLOPT_QUOTE</td>
 * An array of FTP commands to execute on the service prior to the FTP
 * request.
 * </td>
 * </td>
 * </tr>
 ...
 * handshake when reconnecting to the same service. Note that SSL
