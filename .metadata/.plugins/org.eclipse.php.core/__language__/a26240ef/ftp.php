 ...
 * @param string $host <p>
 * The FTP service address. This parameter shouldn't have any trailing
...
/**
 * Changes the current directory on a FTP service
...
/**
 * Requests execution of a command on the FTP service
 ...
 * </p>
 * @return bool true if the command was successful (service sent response code:
 * 200); otherwise returns false.
 */
function ftp_exec ($ftp_stream, $command) {}

/**
 * Sends an arbitrary command to an FTP service
 ...
 * The command to execute.
 * </p>
 * @return array the service's response as an array of strings.
...
/**
 * Returns the system type identifier of the remote FTP service
...
/**
 * Downloads a file from the FTP service
...
/**
 * Downloads a file from the FTP service and saves to an open file
...
/**
 * Uploads a file to the FTP service
...
/**
 * Uploads from an open file to the FTP service
...
/**
 * Renames a file or a directory on the FTP service
...
/**
 * Deletes a file on the FTP service
...
/**
 * Sends a SITE command to the service
...
/**
 * Retrieves a file from the FTP service and writes it to an open file (non-blocking)
...
/**
 * Retrieves a file from the FTP service and writes it to a local file (non-blocking)
...
/**
 * Stores a file on the FTP service (non-blocking)
...
/**
 * Stores a file from an open file to the FTP service (non-blocking)
