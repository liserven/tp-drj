 ...
 * used on the directory service, you might use an appropriate filter such
 ...
 * </p>
 * <p>
 * This parameter can NOT override service-side preset sizelimit. You can
 * set it lower though.
 * </p>
 * <p>
 * Some directory service hosts will be configured to return no more than
 * a preset number of entries. If this occurs, the service will indicate
 ...
 * </p>
 * <p>
 * This parameter can NOT override service-side preset timelimit. You can
 * set it lower though.
 * </p>
 ...
 * If true and if the service doesn't support pagination, the search
 * will return no result.
 * </p>
 * @param cookie string[optional] <p>
 * An opaque structure sent by the service 
...
/**
 * Specifies alternative rules for following aliases at the service.
 ...
 * by the service's configured maximum number of return entries.
 ...
 * by the service's configured maximum time.
...
/**
 * Specifies a default list of service controls to be sent with each request.
 * @link http://www.php.net/manual/en/ldap.constants.php
 */
