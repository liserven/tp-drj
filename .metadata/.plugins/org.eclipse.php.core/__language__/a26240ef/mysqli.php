...
class mysqli  {
	...
	/**
	 * Asks the service to kill a MySQL thread
	...
	/**
	 * Open a new connection to the MySQL service
	 ...
	 * If not provided or &null;, the MySQL service will attempt to authenticate
	 ...
	 * Specifies the port number to attempt to connect to the MySQL service.
	 * </p>
	 ...
	 * connecting to the MySQL service. How the connection is made to the
	 ...
	 * <td>command to execute after when connecting to MySQL service</td>
	 * </tr>
	 * <tr valign="top">
	...
	/**
	 * Pings a service connection, or tries to reconnect if the connection has gone down
	...
	/**
	 * Opens a connection to a mysql service
	 ...
	 * </p>
	 * @param string $passwd [optional] <p>
	 * If provided or &null;, the MySQL service will attempt to authenticate
	 * the user against those user records which have no password only. This
	 * allows one username to be used with different permissions (depending
	 * on if a password as provided or not).
	 * </p>
	 ...
	 * @param mysqli $link 
	 * @return string A string describing the service status. false if an error occurred.
	 */
...
class mysqli_stmt  {
	 ...
	 * <td>
	 * Number of rows to fetch from service at a time when using a cursor.
...
/**
 * <p>
 * Command to execute when connecting to MySQL service. Will automatically be re-executed when reconnecting.
 * </p>
 * @link http://www.php.net/manual/en/mysqli.constants.php
 */
...
/**
 * <p>
 * On a slave replication service: resets the master service information, and 
...
/**
 * <p>
 * On a master replication service: removes the binary log files listed in the
