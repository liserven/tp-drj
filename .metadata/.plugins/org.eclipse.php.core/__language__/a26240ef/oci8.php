...
class OCI_Lob  {
	...
	/**
	 * Flushes/writes buffer of the LOB to the service
...
/**
 * Connect to the Oracle service using a unique connection
 ...
 * are fetched which may result in reduced service-side
 * resource usage.
 * @link http://www.php.net/manual/en/oci8.constants.php
 */
