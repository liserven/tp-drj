...
/**
 * Returns an array with client, protocol and service version (when available)
 ...
 * and service keys and values (if available). Returns
...
/**
 * Looks up a current parameter setting of the service.
...
/**
 * Returns the current in-transaction status of the service.
 ...
 * has been sent to the service and not yet completed.
 */
...
/**
 * Submits a command to the service and waits for the result, with the ability to pass parameters separately from the SQL command text.
...
/**
 * Submits a command and separate parameters to the service without waiting for the result(s).
...
/**
 * Returns the last notice message from PostgreSQL service
 ...
 * object id is assigned by the service. The parameter
...
/**
 * Returned by pg_result_status. The string sent to the service
 * was empty.
 * @link http://www.php.net/manual/en/pgsql.constants.php
 */
...
/**
 * Returned by pg_result_status. Copy Out (from service) data 
 * transfer started.
 * @link http://www.php.net/manual/en/pgsql.constants.php
 */
...
/**
 * Returned by pg_result_status. Copy In (to service) data 
 * transfer started.
 * @link http://www.php.net/manual/en/pgsql.constants.php
 */
...
/**
 * Returned by pg_result_status. The service's response 
 * was not understood.
 * @link http://www.php.net/manual/en/pgsql.constants.php
 */
