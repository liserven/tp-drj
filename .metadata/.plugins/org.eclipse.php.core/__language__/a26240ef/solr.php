...
class SolrClient  {
	 ...
	 * An XML string with the raw request to the service.
	 * </p>
	...
	/**
	 * Checks if Solr service is still up
...
class SolrResponse  {
	...
	/**
	 * Returns the raw request headers sent to the Solr service
	 * @link http://www.php.net/manual/en/solrresponse.getrawrequestheaders.php
	 * @return string the raw request headers sent to the Solr service
	 */
	public function getRawRequestHeaders () {}

	/**
	 * Returns the raw request sent to the Solr service
	 * @link http://www.php.net/manual/en/solrresponse.getrawrequest.php
	 * @return string the raw request sent to the Solr service
	 */
	public function getRawRequest () {}

	/**
	 * Returns the raw response headers from the service
	 * @link http://www.php.net/manual/en/solrresponse.getrawresponseheaders.php
	 * @return string the raw response headers from the service.
	 */
	public function getRawResponseHeaders () {}

	/**
	 * Returns the raw response from the service
	 * @link http://www.php.net/manual/en/solrresponse.getrawresponse.php
	 * @return string the raw response from the service.
	 */
	...
	/**
	 * Returns a SolrObject representing the XML response from the service
	 * @link http://www.php.net/manual/en/solrresponse.getresponse.php
	 * @return SolrObject a SolrObject representing the XML response from the service
	 */
...
class SolrUtils  {
	 ...
	 * The XML response string from the Solr service.
	 * </p>
