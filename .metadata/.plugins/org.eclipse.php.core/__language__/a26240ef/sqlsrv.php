 ...
 * The name of the service to which a connection is established. To connect 
 * to a specific instance, follow the service name with a forward slash 
 * and the instance name (e.g. serverName\sqlexpress).
 * </p>
 * @param connectionInfo array[optional] <p>
 * An associative array that specifies options for connecting to the service. 
 ...
 * @param conn resource <p>
 * The connection resource that connects the client and the service.
 * </p>
...
/**
 * Sends data from parameter streams to the service
