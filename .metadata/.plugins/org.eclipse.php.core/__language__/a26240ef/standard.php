 ...
 * <td>CREDITS_SAPI</td>
 * <td>
 * A list of the service API modules for PHP, and their authors
 * </td>
 * </tr>
 * </table>
 * </p>
...
/**
 * Returns the type of interface between web service and PHP
 ...
 * The path on the service in which the cookie will be available on.
 ...
 * On the service-side, it's on the programmer to send this
 ...
 * provided and it is not invoked in a web service environment (such as from a
 * CLI application). true will be returned if
 * response_code is provided and it is not invoked in a
 * web service environment (but only when no previous response status has been
 * set).
 */
 ...
 * In case of raw mode, we query only the requested type instead of looping
 ...
 * length of time has passed since the authoritative name service was queried.
 * </td>
 * </tr>
 * </table>
 * </p>
 ...
 * <td>NS</td>
 * <td>
 * target: FQDN of the name service which is authoritative
 * for this hostname.
 * </td>
 * </tr>
 * <tr valign="top">
 ...
 * DNS service should retain remote copies of the zone data without a
 * successful refresh before discarding.
 * minimum-ttl: Minimum length of time (seconds) a
 * client can continue to use a DNS resolution before it should request
 * a new resolution from the service. Can be overridden by individual
 * resource records.
 * </td>
 * </tr>
 * <tr valign="top">
...
/**
 * Create an Internet or Unix domain service socket
 ...
 * The service socket to accept a connection from.
 * </p>
 * @param float $timeout [optional] <p>
...
/**
 * Fetches all the headers sent by the service in response to a HTTP request
 ...
 * </p>
 * <p>
 * (Windows only) When PHP is talking to a SMTP service directly, if a full
 ...
 * must use this flag, otherwise the service socket will not be enabled.
...
/**
 * Iteratively query the name service for
