!function (t, e) {
    ...
    return function (t) {
        ...
        "use strict";
        var o = n(2), r = n(5), i = n(6), s = n(59), a = n(60), c = n(61), u = n(62), p = n(63)(), h = n(64),
            l = function (t) {
                var e = t || {};
                this.opts = {
        ...
        l.prototype.init = function (t) {
            var e = this;
            return e.autoDiscon = !0, t.flag !== s.SYNC_TYPE_OPEN && t.flag !== s.SYNC_TYPE_CLOSE || (e.channel.sync_type = t.flag), t.fromPlatForm = s.FROM_PLATFORM, new a(this.channel).setEvent(s.EVENTS.INIT).setData(t).send().addHook(function (n, o) {
            ...
            var e = this, n = new a(this.channel).setEvent(s.EVENTS.LOGIN).setData(t).addHook(function (n, o) {
                e.current_user = t.username, h.StorageUtils.removeItems(e.current_user), e.channel.sync_key = 0, e.channel.sync_event_key = 0, e.channel.msg_receipt_key = 0, e.channel.ses_key = s.SESSION_KEY + e.current_appkey + "-" + e.current_user, e.channel.conversations_key = s.CONVERSATION_KEY + e.current_appkey + "-" + e.current_user, e.channel.event_key = s.EVENT_KEY + e.current_appkey + "-" + e.current_user, e._syncCheckTask(), e._receiptReportTask(), e._initConversation(), e.lastMsgs = {}, e.channel.client.removeListener(s.EVENTS.LOGIN), e._addEventListen(), e.firstLogin = !1, o && o(n)
            });
            ...
            return this.__uploadFile({
                ...
                e.setData({avatar: n.media_id}).send()
            }), e
            ...
            n.lastMsgs[e] && (o = n.lastMsgs[e].last_msg_time), n.conversations[e].recent_time = o, n.current_conversation = e, h.StorageUtils.addItem(n.channel.conversations_key, JSON.stringify(n.conversations))
        }, l.prototype.getUnreadMsgCnt = function (t) {
            this.__checkLogin();
            var e, n = this;
            return t.gid ? e = String(t.gid) : (t.appkey || (t.appkey = n.current_appkey), e = t.appkey + t.username), n.conversations[e] || (n.conversations[e] = {}), n.conversations[e].unread_msg_count ? n.conversations[e].unread_msg_count : 0
            ...
            return this.__checkLogin(), new a(this.channel).setEvent(s.EVENTS.GET_GROUPS_LIST).setData({}).send().addHook(function (t, e) {
                t.group_list.forEach(function (t) {
                    t.group_type = t.flag, delete t.flag
                }), e && e(t)
            })
        }, l.prototype.getGroupInfo = function (t) {
            return this.__checkLogin(), new a(this.channel).setEvent(s.EVENTS.GET_GROUP_INFO).setData(t).send().addHook(function (t, e) {
            ...
            return this.__checkLogin(), new a(this.channel).setEvent(s.EVENTS.NO_DISTURB).setData({version: 0}).send().addHook(function (t, e) {
            ...
            return this.__checkLogin(), new a(this.channel).setEvent(s.EVENTS.LIST_SHIELD_GROUP).setData({}).send().addHook(function (t, e) {
            ...
            this.__checkLogin();
            var e, n = this;
            t.appkey || (t.appkey = n.current_appkey), t.gid ? e = t.gid : t.username && (e = t.appkey + t.username), e && t.extras && (n.conversations[e] || (n.conversations[e] = {}), n.conversations[e].extras = t.extras), h.StorageUtils.addItem(n.channel.conversations_key, JSON.stringify(n.conversations))
            ...
            return this.__checkLogin(), !t && (t = {}), new a(this.channel).setEvent(s.EVENTS.ROOM_LIST).setData(t).send().addHook(function (t, e) {
                t.result.rooms.forEach(function (t) {
                    h.Cache.rooms[t.id] = t
                }), e && e(t)
            })
        }, l.prototype.getSelfChatrooms = function () {
            return this.__checkLogin(), new a(this.channel).setEvent(s.EVENTS.ROOM_LIST_SELF).setData({}).send().addHook(function (t, e) {
            ...
            return this.__checkLogin(), t.target_rname || (t.target_rname = void 0 === h.Cache.rooms[t.target_rid] ? "" : h.Cache.rooms[t.target_rid].name), this.__sendMsg({
                type: "chatroom",
            ...
            return this.__checkLogin(), t.target_rname || (t.target_rname = void 0 === h.Cache.rooms[t.target_rid] ? "" : h.Cache.rooms[t.target_rid].name), this.__sendPic({
                type: "chatroom",
                target_id: t.target_rid,
                target_name: t.target_rname,
                file: t.image,
            ...
            return this.__checkLogin(), t.target_rname || (t.target_rname = void 0 === h.Cache.rooms[t.target_rid] ? "" : h.Cache.rooms[t.target_rid].name), this.__sendFile({
                type: "chatroom",
                target_id: t.target_rid,
                target_name: t.target_rname,
                file: t.file,
            ...
            return this.__checkLogin(), t.target_rname || (t.target_rname = void 0 === h.Cache.rooms[t.target_rid] ? "" : h.Cache.rooms[t.target_rid].name), this.__sendCustom({
                type: "chatroom",
                target_id: t.target_rid,
                target_name: t.target_rname,
                custom: t.custom,
            ...
            return this.__checkLogin(), t.target_rname || (t.target_rname = void 0 === h.Cache.rooms[t.target_rid] ? "" : h.Cache.rooms[t.target_rid].name), this.__sendLocation({
                type: "chatroom",
                target_id: t.target_rid,
                target_name: t.target_rname,
                latitude: t.latitude,
            ...
            return this.__checkLogin(), t.keep_silence = !0, new a(this.channel).setEvent(s.EVENTS.GROUP_MEM_SILENCE).setData(t).send()
        }, l.prototype.delGroupMemSilence = function (t) {
            return this.__checkLogin(), t.keep_silence = !1, new a(this.channel).setEvent(s.EVENTS.GROUP_MEM_SILENCE).setData(t).send()
            ...
            return this.__checkLogin(), new a(this.channel).setEvent(s.EVENTS.PUBLIC_GROUP_LIST).setData(t).send().addHook(function (t, e) {
            ...
            t.messages.forEach(function (n) {
                h.Cache.rooms[n.room_id] || e.getChatroomInfo({id: t.room_id}), n.msgs && n.msgs.forEach(function (t) {
            ...
            Array.prototype.push.apply([], t.messages.map(function (t) {
                ...
                if (t.content.sui_mtime && e[t.from_uid] && t.content.sui_mtime > new Date(e[t.from_uid]).getTime() / 1e3) {
                    ...
                    var n = {};
                    n.from_username = t.content.from_id, n.from_appkey = t.content.from_appkey, n.mtime = t.content.sui_mtime, delete t.content.sui_mtime, e._updateInfoEventFun && e._updateInfoEventFun(n)
                }
                var o;
                ...
                var r = !1;
                t.from_appkey === e.current_appkey && t.from_username === e.current_user && (r = !0, o = (void 0 === t.content.target_appkey || "" === t.content.target_appkey ? t.content.from_appkey : t.content.target_appkey) + t.content.target_id);
                e.lastMsgs[o] = {last_msg_time: t.ctime_ms}, e.conversations[o] || (e.conversations[o] = {}, e.conversations[o].extras = {}, e.conversations[o].unread_msg_count = 0, e.conversations[o].msg_time = []), e.current_conversation === o || r ? (e.conversations[o].recent_time = t.ctime_ms, e.conversations[o].unread_msg_count = 0, e.conversations[o].msg_time = []) : (e.conversations[o].unread_msg_count = e.conversations[o].unread_msg_count + 1, e.conversations[o].msg_time.push(t.ctime_ms)), new a(e.channel).setEvent(s.EVENTS.MSG_RECV_V2).setData({
                    msg_id: t.msg_id,
                    msg_type: t.msg_type,
                    from_uid: t.from_uid,
                    from_gid: t.from_gid
                }).send()
            }), h.StorageUtils.addItem(e.channel.conversations_key, JSON.stringify(e.conversations)), this._onMsgReceiveFn && this._onMsgReceiveFn(t)
            ...
            if (200 !== t.event_type) {
                ...
                if (56 === t.event_type && 10 == t.extra ? (n.by_self = !1, delete n.extra) : 56 === t.event_type && 59 == t.extra && (n.by_self = !0, delete n.extra), 1 === t.event_type) {
                    var o = {event_id: t.event_id, event_type: t.event_type, from_uid: t.from_uid, gid: t.gid};
            ...
            } else 3 === t.description.type ? e._dealMutlReadEvent(t.description.type, t.ctime_ms, t.description.appkey, t.description.username) : e._dealMutlReadEvent(t.description.type, t.ctime_ms, t.description.gid)
            ...
            e.channel.sync_key = t.sync_key, t.messages && (t.messages.forEach(function (t) {
                ...
                if (e.current_conversation === n) e.conversations[n] = void 0 === e.conversations[n] ? {} : e.conversations[n], e.conversations[n].unread_msg_count = o, e.conversations[n].recent_time = r, e.conversations[n].msg_time = []; else if (e.conversations[n] && e.conversations[n].recent_time) {
                    var i = e.conversations[n].recent_time;
                    t.msgs.forEach(function (t) {
                        t.ctime_ms <= i || t.content.from_appkey === e.current_appkey && t.content.from_id === e.current_user ? (o = 0, e.conversations[n].msg_time = []) : (o++, e.conversations[n].msg_time.push(t.ctime_ms))
                    }), e.channel.sync_type === s.SYNC_TYPE_OPEN ? e.conversations[n].unread_msg_count = o : e.conversations[n].unread_msg_count += o
                } else o = t.unsync_count, e.conversations[n] = void 0 === e.conversations[n] ? {} : e.conversations[n], e.conversations[n].unread_msg_count = o, t.msgs.length - 1 - o < 0 ? e.conversations[n].recent_time = -1 : e.conversations[n].recent_time = t.msgs[t.msgs.length - 1 - o].ctime_ms, e.conversations[n].msg_time = [];
                e.lastMsgs[n] = {last_msg_time: r}, delete t.unsync_count, t.unread_msg_count = e.conversations[n].unread_msg_count
                ...
                if (e._onSyncEventFn && t.events && t.events.length > 0) {
                    ...
                    t.events.forEach(function (o) {
                        if (200 === o.event_type) 3 === o.description.type ? e._dealMutlReadEvent(o.description.type, o.ctime_ms, o.description.appkey, o.description.username) : e._dealMutlReadEvent(o.description.type, o.ctime_ms, o.description.gid); else {
                            ...
                            56 === t.event_type && 10 == t.extra ? (delete r.extra, r.by_self = !1) : 56 === t.event_type && 59 == t.extra && (delete r.extra, r.by_self = !0), n.push(r)
                        }
                    }), e._onSyncEventFn(n)
                }
            }, 1700)
            ...
            var r = {sync_key: e.channel.msg_receipt_key};
            ...
            var r, i = this, s = {};
            if (s.type = t, 3 === t ? (r = n + o, s.username = o, s.appkey = n) : (r = String(n), s.gid = n), i.conversations[r] = void 0 === i.conversations[r] ? {
                    msg_time: [],
                    unread_msg_count: 0
                } : i.conversations[r], i.conversations[r].recent_time = e, i.current_conversation === r) i.conversations[r].unread_msg_count = 0, i.conversations[r].msg_time = []; else {
                var a = i.conversations[r].unread_msg_count, c = [], u = 0;
                i.conversations[r].msg_time.forEach(function (t) {
                    t > e && (u++, c.push(t))
                }), i.conversations[r].msg_time = c, u < a && (i.conversations[r].unread_msg_count = u, s.unreadCount = u, h.StorageUtils.addItem(i.channel.conversations_key, JSON.stringify(i.conversations)), i._conversationUpdateFun && i._conversationUpdateFun(s))
            }
            ...
            if (this.report.length > 0) {
                ...
                this.report.forEach(function (n) {
                    ...
                    } else t[n.args.key] = String(e.length), e.push({result: n.args, msg_reports: [n]})
                }), this.report = [];
                for (var n = 0; n < e.length; n++) e[n].result.msg_ids = h.ArrayUtils.delRepeatItem(e[n].result.msg_ids), delete e[n].result.key, this._msgReceipt(e[n])
            }
            ...
            n.open("POST", this.opts.upload_file + "?type=" + t.type), n.setRequestHeader("X-App-Key", t.appkey), n.setRequestHeader("jm-channel", s.PLAT_CHANNEL), n.setRequestHeader("Authorization", "Basic " + r.btoa(t.username + ":" + t.token)), n.onreadystatechange = function () {
                if (4 === this.readyState) if (200 === this.status) {
                    var t = JSON.parse(this.responseText);
                    e(null, t)
                } else try {
                    var n = JSON.parse(this.responseText);
                    898061 === n.error.code ? e({code: 880210, message: "file size exceed limit"}) : e(n)
                } catch (t) {
            ...
            o(function (t) {
                ...
                n.__uploadFile0({type: t.type, file: t.file, appkey: t.appkey, username: t.username, token: o}, e)
            }).then(function (t, n) {
                e(null, n)
            }).fail(function (t, n) {
                e({data: n})
            ...
            this.__checkLogin();
            return new a(this.channel).setEvent("single" === t.type ? s.EVENTS.S_SINGLE_TEXT : "group" === t.type ? s.EVENTS.SEND_GROUP_MSG : s.EVENTS.SEND_ROOM_MSG).setData(new u(this.current_user, this.current_appkey).setType(t.type).setAppkey(t.appkey).setNeedReceipt(t.need_receipt).setTarget(t.target_id, t.target_name).setText(t.content ? t.content : t.msg_body.text, t.content ? t.extras : t.msg_body.extras).setAtList(t.at_list).setNoOffline(!0 === t.no_offline).setNoNotification(!0 === t.no_notification).setCustomNotification(t.custom_notification).build()).send()
        },l.prototype.__sendPic = function (t) {
            this.__checkLogin();
            var e = new a(this.channel).setEvent("single" === t.type ? s.EVENTS.S_SINGLE_TEXT : "group" === t.type ? s.EVENTS.SEND_GROUP_MSG : s.EVENTS.SEND_ROOM_MSG),
                n = new u(this.current_user, this.current_appkey).setType(t.type).setAppkey(t.appkey).setNeedReceipt(t.need_receipt).setTarget(t.target_id, t.target_name).setNoOffline(!0 === t.no_offline).setNoNotification(!0 === t.no_notification).setCustomNotification(t.custom_notification);
        ...
        (function (n) {
            !function (n, s) {
                "use strict";
                "object" == typeof t && "object" == typeof t.exports ? t.exports = s() : (r = [], void 0 === (i = "function" == typeof(o = s) ? o.apply(e, r) : o) || (t.exports = i))
            }("object" == typeof window && window, function () {
                "use strict";
                var t = 100, e = Object.prototype.toString, o = Object.prototype.hasOwnProperty,
                ...
                function p(t, e) {
                    var n, o, r = this;
                    return t instanceof p ? t : r instanceof p ? (r._chain = 0, r._success = r._parallel = r._series = null, r._finally = r._error = r._result = r._nextThen = null, arguments.length ? (n = d(r, e), void(void 0 === (t = null == (o = t) ? o : "function" == typeof o.toThunk ? o.toThunk() : "function" == typeof o.then ? function (t) {
                        o.then(function (e) {
                            t(null, e)
                        }, t)
                ...
                function l() {
                    var t = this, e = s(arguments);
                    !1 !== t._result && (!t._result && t._chain && t.debug.apply(t, ["\nChain " + t._chain + ": "].concat(s(e))), t._result = !1, a(function (n) {
                        n === e[0] ? function (t, e) {
                            var n = t, o = t._error || t._finally;
                ...
                function f(t, e) {
                    if (null == e[0]) e[0] = null; else if (e = [e[0]], !t._finally) throw e[0];
        ...
        (function (t, o) {
            var r = n(4).nextTick, i = Function.prototype.apply, s = Array.prototype.slice, a = {}, c = 0;
            ...
            e.setTimeout = function () {
                ...
                var n = c++, o = !(arguments.length < 2) && s.call(arguments, 1);
        ...
        }, r.title = "browser", r.browser = !0, r.env = {}, r.argv = [], r.version = "", r.versions = {}, r.on = _, r.addListener = _, r.once = _, r.off = _, r.removeListener = _, r.removeAllListeners = _, r.emit = _, r.binding = function (t) {
        ...
        !function () {
            var t = e, n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
            ...
            o.prototype = new Error, o.prototype.name = "InvalidCharacterError", t.btoa || (t.btoa = function (t) {
                for (var e, r, i = String(t), s = 0, a = n, c = ""; i.charAt(0 | s) || (a = "=", s % 1); c += a.charAt(63 & e >> 8 - s % 1 * 8)) {
                    if ((r = i.charCodeAt(s += .75)) > 255) throw new o("'btoa' failed: The string to be encoded contains characters outside of the Latin1 range.");
                    e = e << 8 | r
                }
                return c
                ...
                for (var r, i, s = 0, a = 0, c = ""; i = e.charAt(a++); ~i && (r = s % 4 ? 64 * r + i : i, s++ % 4) ? c += String.fromCharCode(255 & r >> (-2 * s & 6)) : 0) i = n.indexOf(i);
                return c
            })
        }()
    }, function (t, e, n) {
        "use strict";
        var o = n(7), r = n(8), i = n(59), s = function (t) {
            this.init(t)
        };
        s.prototype.init = function (t) {
            this.opts = t, this.dataCache = {}, this.memStore = {}, this.sync_key = 0, this.sync_type = 0, this.client = r(this.opts.address, {transports: ["websocket", "polling"]});
            var e = this, n = o.prototype.emit, i = this.client.onevent;
            ...
            if (this.opts.debug && console.info("---<- event:%s, data:%s", t, JSON.stringify(e)), t !== i.EVENTS.EVENT_NOTIFICATION && t !== i.EVENTS.MSG_SYNC && t !== i.EVENTS.SYNC_CONVERSATION && t !== i.EVENTS.SYNC_EVENT && t !== i.EVENTS.SYNC_RECEIPT && t !== i.EVENTS.RECEIPT_CHANGE && t !== i.ROOM_MSG_SYNC && t !== i.ROOM_MSG_SYNC_HIS) {
        ...
        t.exports = o, o.prototype.on = o.prototype.addEventListener = function (t, e) {
            ...
            for (var r = 0; r < o.length; r++) if ((n = o[r]) === e || n.fn === e) {
                o.splice(r, 1);
                break
            }
            return this
        ...
        var o = n(9), r = n(14), i = n(25), s = n(11)("socket.io-client");
        t.exports = e = c;
        var a = e.managers = {};

        function c(t, e) {
            "object" == typeof t && (e = t, t = void 0), e = e || {};
            var n, r = o(t), c = r.source, u = r.id, p = r.path, h = a[u] && p in a[u].nsps;
            return e.forceNew || e["force new connection"] || !1 === e.multiplex || h ? (s("ignoring socket cache for %s", c), n = i(c, e)) : (a[u] || (s("new io instance for %s", c), a[u] = i(c, e)), n = a[u]), r.query && !e.query ? e.query = r.query : e && "object" == typeof e.query && (e.query = function (t) {
                var e = [];
        ...
        (function (e) {
            var o = n(10), r = n(11)("socket.io-client:url");
            t.exports = function (t, n) {
                var i = t;
                n = n || e.location, null == t && (t = n.protocol + "//" + n.host);
                "string" == typeof t && ("/" === t.charAt(0) && (t = "/" === t.charAt(1) ? n.protocol + t : n.host + t), /^(https?|wss?):\/\//.test(t) || (r("protocol-less url %s", t), t = void 0 !== n ? n.protocol + "//" + t : "https://" + t), r("parse %s", t), i = o(t));
        ...
        (function (o) {
            ...
            (e = t.exports = n(12)).log = function () {
                ...
                var o = "color: " + this.color, r = 0, i = 0;
                return (t = [t[0], o, "color: inherit"].concat(Array.prototype.slice.call(t, 1)))[0].replace(/%[a-z%]/g, function (t) {
                    "%%" !== t && "%c" === t && (i = ++r)
                }), t.splice(i, 0, o), t
            }, e.save = function (t) {
                try {
        ...
        (e = t.exports = i.debug = i).coerce = function (t) {
            ...
            e.save(t);
            for (var n = (t || "").split(/[\s,]+/), o = n.length, r = 0; r < o; r++) n[r] && ("-" === (t = n[r].replace(/[\\^$+?.()|[\]{}]/g, "\\$&").replace(/\*/g, ".*?"))[0] ? e.skips.push(new RegExp("^" + t.substr(1) + "$")) : e.names.push(new RegExp("^" + t + "$")))
        ...
        function i(t) {
            ...
            function i() {
                var t = i, n = +new Date, s = n - (o || n);
                t.diff = s, t.prev = o, t.curr = n, o = n, null == t.useColors && (t.useColors = e.useColors()), null == t.color && t.useColors && (t.color = e.colors[r++ % e.colors.length]);
        ...
        var n = 1e3, o = 60 * n, r = 60 * o, i = 24 * r, s = 365.25 * i;
        ...
        t.exports = function (t, e) {
            ...
            if ("number" === u && !1 === isNaN(t)) return e.long ? a(c = t, i, "day") || a(c, r, "hour") || a(c, o, "minute") || a(c, n, "second") || c + " ms" : function (t) {
        ...
        var o = n(15)("socket.io-parser"), r = n(18), i = n(21), s = n(22), a = n(24);
        ...
        function u(t) {
            var n = "", i = !1;
            return n += t.type, e.BINARY_EVENT != t.type && e.BINARY_ACK != t.type || (n += t.attachments, n += "-"), t.nsp && "/" != t.nsp && (i = !0, n += t.nsp), null != t.id && (i && (n += ",", i = !1), n += t.id), null != t.data && (i && (n += ","), n += r.stringify(t.data)), o("encoded %j as %s", t, n), n
        }
        ...
        e.protocol = 4, e.types = ["CONNECT", "DISCONNECT", "EVENT", "ACK", "ERROR", "BINARY_EVENT", "BINARY_ACK"], e.CONNECT = 0, e.DISCONNECT = 1, e.EVENT = 2, e.ACK = 3, e.ERROR = 4, e.BINARY_EVENT = 5, e.BINARY_ACK = 6, e.Encoder = c, e.Decoder = p, c.prototype.encode = function (t, n) {
            (o("encoding packet %j", t), e.BINARY_EVENT == t.type || e.BINARY_ACK == t.type) ? function (t, e) {
                s.removeBlobs(t, function (t) {
                    var n = s.deconstructPacket(t), o = u(n.packet), r = n.buffers;
                    r.unshift(o), e(r)
                })
            }(t, n) : n([u(t)])
        ...
        (e = t.exports = function (t) {
            ...
            e.save(t);
            for (var n = (t || "").split(/[\s,]+/), o = n.length, r = 0; r < o; r++) n[r] && ("-" === (t = n[r].replace(/\*/g, ".*?"))[0] ? e.skips.push(new RegExp("^" + t.substr(1) + "$")) : e.names.push(new RegExp("^" + t + "$")))
        }, e.enabled = function (t) {
            var n, o;
            for (n = 0, o = e.skips.length; n < o; n++) if (e.skips[n].test(t)) return !1;
            for (n = 0, o = e.names.length; n < o; n++) if (e.names[n].test(t)) return !0;
        ...
        t.exports = function (t, e) {
            ...
            }(t) : e.long ? a(u = t, i, "day") || a(u, r, "hour") || a(u, o, "minute") || a(u, n, "second") || u + " ms" : (c = t) >= i ? Math.round(c / i) + "d" : c >= r ? Math.round(c / r) + "h" : c >= o ? Math.round(c / o) + "m" : c >= n ? Math.round(c / n) + "s" : c + "ms";
            var c, u
        }
    }, function (t, e, n) {
        var o;
        (function (t, r) {
            (function () {
                var i = n(20), s = {function: !0, object: !0}, a = s[typeof e] && e && !e.nodeType && e,
                    c = s[typeof window] && window || this,
                    u = a && s[typeof t] && t && !t.nodeType && "object" == typeof r && r;

                function p(t, e) {
                    t || (t = c.Object()), e || (e = c.Object());
                    var n = t.Number || c.Number, o = t.String || c.String, r = t.Object || c.Object,
                        i = t.Date || c.Date, a = t.SyntaxError || c.SyntaxError, u = t.TypeError || c.TypeError,
                        h = t.Math || c.Math, l = t.JSON || c.JSON;
                    "object" == typeof l && l && (e.stringify = l.stringify, e.parse = l.parse);
                    var f, d, _, y = r.prototype, g = y.toString, m = new i(-0xc782b5b800cec);
                    try {
                    ...
                    if (!v("json")) {
                        var E = "[object Function]", k = "[object Number]", S = "[object String]", T = "[object Array]",
                            b = v("bug-string-char-index");
                        if (!m) var N = h.floor, w = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
                            R = function (t, e) {
                                return w[e] + 365 * (t - 1970) + N((t - 1969 + (e = +(e > 1))) / 4) - N((t - 1901 + e) / 100) + N((t - 1601 + e) / 400)
                            };
                        if ((f = y.hasOwnProperty) || (f = function (t) {
                                var e, n = {};
                                return (n.__proto__ = null, n.__proto__ = {toString: 1}, n).toString != g ? f = function (t) {
                                ...
                                } : (o = ["valueOf", "toString", "toLocaleString", "propertyIsEnumerable", "isPrototypeOf", "hasOwnProperty", "constructor"], d = function (t, e) {
                            ...
                            var C = {92: "\\\\", 34: '\\"', 8: "\\b", 12: "\\f", 10: "\\n", 13: "\\r", 9: "\\t"},
                                A = function (t, e) {
                                    ...
                                    if ("object" == typeof a && a) if ("[object Date]" != (c = g.call(a)) || f.call(a, "toJSON")) "function" == typeof a.toJSON && (c != k && c != S && c != T || f.call(a, "toJSON")) && (a = a.toJSON(t)); else if (a > -1 / 0 && a < 1 / 0) {
                                        if (R) {
                                            for (l = N(a / 864e5), p = N(l / 365.2425) + 1970 - 1; R(p + 1, 0) <= l; p++) ;
                                            for (h = N((l - R(p, 0)) / 30.42); R(p, h + 1) <= l; h++) ;
                                            l = 1 + l - R(p, h), m = N((y = (a % 864e5 + 864e5) % 864e5) / 36e5) % 24, v = N(y / 6e4) % 60, E = N(y / 1e3) % 60, b = y % 1e3
                                        } else p = a.getUTCFullYear(), h = a.getUTCMonth(), l = a.getUTCDate(), m = a.getUTCHours(), v = a.getUTCMinutes(), E = a.getUTCSeconds(), b = a.getUTCMilliseconds();
                                        a = (p <= 0 || p >= 1e4 ? (p < 0 ? "-" : "+") + A(6, p < 0 ? -p : p) : A(4, p)) + "-" + A(2, h + 1) + "-" + A(2, l) + "T" + A(2, m) + ":" + A(2, v) + ":" + A(2, E) + "." + A(3, b) + "Z"
                                    } else a = null;
                                    ...
                                    if (c == S) return O("" + a);
                                    if ("object" == typeof a) {
                                        for (x = s.length; x--;) if (s[x] === a) throw u();
                            ...
                            e.stringify = function (t, e, n) {
                                var o, r, i, a;
                                if (s[typeof e] && e) if ((a = g.call(e)) == E) r = e; else if (a == T) {
                                    i = {};
                        ...
                        if (!v("json-parse")) {
                            var I, x, L = o.fromCharCode,
                                ...
                                P = function () {
                                    ...
                                    for (var t, e, n, o, r, i = x, s = i.length; I < s;) switch (r = i.charCodeAt(I)) {
                                        ...
                                        case 34:
                                            for (t = "@", I++; I < s;) if ((r = i.charCodeAt(I)) < 32) P(); else if (92 == r) switch (r = i.charCodeAt(++I)) {
                                                case 92:
                                                case 34:
                                                case 47:
                                                case 98:
                                                ...
                                                case 114:
                                                    ...
                                                    break;
                                                case 117:
                                                    for (e = ++I, n = I + 4; I < n; I++) (r = i.charCodeAt(I)) >= 48 && r <= 57 || r >= 97 && r <= 102 || r >= 65 && r <= 70 || P();
                                                    t += L("0x" + i.slice(e, I));
                                                    break;
                                                default:
                                                    P()
                                        ...
                                        default:
                                            if (e = I, 45 == r && (o = !0, r = i.charCodeAt(++I)), r >= 48 && r <= 57) {
                                                for (48 == r && ((r = i.charCodeAt(I + 1)) >= 48 && r <= 57) && P(), o = !1; I < s && ((r = i.charCodeAt(I)) >= 48 && r <= 57); I++) ;
                                                if (46 == i.charCodeAt(I)) {
                                                    for (n = ++I; n < s && ((r = i.charCodeAt(n)) >= 48 && r <= 57); n++) ;
                                                    n == I && P(), I = n
                                                }
                                                if (101 == (r = i.charCodeAt(I)) || 69 == r) {
                                                    for (43 != (r = i.charCodeAt(++I)) && 45 != r || I++, n = I; n < s && ((r = i.charCodeAt(n)) >= 48 && r <= 57); n++) ;
                                                    n == I && P(), I = n
                                                }
                                                return +i.slice(e, I)
                                            }
                                    ...
                                    if ("$" == t && P(), "string" == typeof t) {
                                        ...
                                        if ("[" == t) {
                                            for (e = []; "]" != (t = U()); n || (n = !0)) n && ("," == t ? "]" == (t = U()) && P() : P()), "," == t && P(), e.push(G(t));
                                            return e
                                        }
                                        if ("{" == t) {
                                            for (e = {}; "}" != (t = U()); n || (n = !0)) n && ("," == t ? "}" == (t = U()) && P() : P()), "," != t && "string" == typeof t && "@" == (b ? t.charAt(0) : t[0]) && ":" == U() || P(), e[t.slice(1)] = G(U());
                                            return e
                                        }
                                        P()
                                    }
                                    ...
                                    var o, r = t[e];
                                    if ("object" == typeof r && r) if (g.call(r) == T) for (o = r.length; o--;) B(r, o, n); else d(r, function (t) {
                                        B(r, t, n)
                                    });
                                    return n.call(t, e, r)
                                };
                            e.parse = function (t, e) {
                                var n, o;
                                return I = 0, x = "" + t, n = G(U()), "$" != U() && P(), I = x = null, e && g.call(e) == E ? V(((o = {})[""] = n, o), "", e) : n
                            }
                        }
                    }
                ...
                if (!u || u.global !== u && u.window !== u && u.self !== u || (c = u), a && !i) p(c, a); else {
                    var h = c.JSON, l = c.JSON3, f = !1, d = p(c, c.JSON3 = {
                        noConflict: function () {
        ...
        (function (t) {
            ...
            e.deconstructPacket = function (t) {
                ...
                return i.data = function t(n) {
                    ...
                    return n
                }(n), i.attachments = e.length, {packet: i, buffers: e}
                ...
                !function e(a, c, u) {
                    ...
                    } else if (o(a)) for (var h = 0; h < a.length; h++) e(a[h], h, a); else if (a && "object" == typeof a && !r(a)) for (var l in a) e(a[l], l, a)
                }(s), i || n(s)
            }
        }).call(e, window)
    }, function (t, e) {
        ...
        var o = n(26), r = n(54), i = n(7), s = n(14), a = n(56), c = n(57), u = n(11)("socket.io-client:manager"),
            p = n(52), h = n(58), l = Object.prototype.hasOwnProperty;
        ...
        function f(t, e) {
            ...
            }), this.timeout(null == e.timeout ? 2e4 : e.timeout), this.readyState = "closed", this.uri = t, this.connecting = [], this.lastPing = null, this.encoding = !1, this.packetBuffer = [], this.encoder = new s.Encoder, this.decoder = new s.Decoder, this.autoConnect = !1 !== e.autoConnect, this.autoConnect && this.open()
        }
        ...
        t.exports = f, f.prototype.emitAll = function () {
            ...
            if (!1 !== this._timeout) {
                ...
                var p = setTimeout(function () {
                    u("connect attempt timed out after %d", c), i.destroy(), n.close(), n.emit("error", "timeout"), r.emitAll("connect_timeout", c)
                }, c);
                this.subs.push({
                    destroy: function () {
                        clearTimeout(p)
        ...
        (function (e) {
            var o = n(29), r = n(7), i = n(46)("engine.io-client:socket"), s = n(52), a = n(35), c = n(10), u = n(53),
                p = n(43);
            ...
            t.exports = h, h.priorWebsocketSuccess = !1, r(h.prototype), h.protocol = a.protocol, h.Socket = h, h.Transport = n(34), h.transports = n(29), h.parser = n(35), h.prototype.createTransport = function (t) {
                ...
                var e = this.createTransport(t, {probe: 1}), n = !1, o = this;
                ...
                function r() {
                    ...
                    n || (i('probe transport "%s" opened', t), e.send([{
                        ...
                        if (!n) if ("pong" === r.type && "probe" === r.data) {
                            ...
                            h.priorWebsocketSuccess = "websocket" === e.name, i('pausing current transport "%s"', o.transport.name), o.transport.pause(function () {
                                n || "closed" !== o.readyState && (i("changing transport and sending upgrade packet"), l(), o.setTransport(e), e.send([{type: "upgrade"}]), o.emit("upgrade", e), e = null, o.upgrading = !1, o.flush())
                            })
                        } else {
                ...
                function a(n) {
                    ...
                    r.transport = e.name, s(), i('probe transport "%s" failed because of error: %s', t, n), o.emit("upgradeError", r)
                }
                ...
                function l() {
                    e.removeListener("open", r), e.removeListener("error", a), e.removeListener("close", c), o.removeListener("close", u), o.removeListener("upgrading", p)
                }

                h.priorWebsocketSuccess = !1, e.once("open", r), e.once("error", a), e.once("close", c), this.once("close", u), this.once("upgrading", p), e.open()
        ...
        (function (t) {
            var o = n(30), r = n(32), i = n(49), s = n(50);
            e.polling = function (e) {
                var n = !1, s = !1, a = !1 !== e.jsonp;
                if (t.location) {
        ...
        (function (e) {
            var o = n(31);
            t.exports = function (t) {
                var n = t.xdomain, r = t.xscheme, i = t.enablesXDR;
                try {
        ...
        (function (e) {
            var o = n(30), r = n(33), i = n(7), s = n(44), a = n(46)("engine.io-client:polling-xhr");
            ...
            t.exports = u, t.exports.Request = p, s(u, r), u.prototype.supportsBinary = !0, u.prototype.request = function (t) {
                ...
                var n = "string" != typeof t && void 0 !== t, o = this.request({method: "POST", data: t, isBinary: n}),
                    r = this;
                ...
                var n = this.xhr = new o(t), r = this;
                try {
                    a("xhr open %s: %s", this.method, this.uri), n.open(this.method, this.uri, this.async);
                    try {
                        if (this.extraHeaders) for (var i in n.setDisableHeaderCheck(!0), this.extraHeaders) this.extraHeaders.hasOwnProperty(i) && n.setRequestHeader(i, this.extraHeaders[i])
                    } catch (t) {
                    }
        ...
        var o = n(34), r = n(43), i = n(35), s = n(44), a = n(45), c = n(46)("engine.io-client:polling");
        t.exports = p;
        var u = null != new (n(30))({xdomain: !1}).responseType;
        ...
        s(p, o), p.prototype.name = "polling", p.prototype.doOpen = function () {
            ...
            return !1 !== this.timestampRequests && (t[this.timestampParam] = a()), this.supportsBinary || t.sid || (t.b64 = 1), t = r.encode(t), this.port && ("https" === e && 443 !== Number(this.port) || "http" === e && 80 !== Number(this.port)) && (n = ":" + this.port), t.length && (t = "?" + t), e + "://" + (-1 !== this.hostname.indexOf(":") ? "[" + this.hostname + "]" : this.hostname) + n + this.path + t
        }
    }, function (t, e, n) {
        var o = n(35), r = n(7);
        ...
        (function (t) {
            var o, r = n(36), i = n(37), s = n(38), a = n(39), c = n(40);
            t && t.ArrayBuffer && (o = n(41));
            var u = "undefined" != typeof navigator && /Android/i.test(navigator.userAgent),
                p = "undefined" != typeof navigator && /PhantomJS/i.test(navigator.userAgent), h = u || p;
            e.protocol = 3;
            var l = e.packets = {open: 0, close: 1, ping: 2, pong: 3, message: 4, upgrade: 5, noop: 6}, f = r(l),
                d = {type: "error", data: "parser error"}, _ = n(42);
            ...
            e.encodePacket = function (n, o, r, i) {
                ...
                if (t.ArrayBuffer && p instanceof ArrayBuffer) return function (t, n, o) {
                    ...
                    var r = t.data, i = new Uint8Array(r), s = new Uint8Array(1 + r.byteLength);
                    s[0] = l[t.type];
                ...
                if ("string" == typeof t) {
                    ...
                    var r = t.charAt(0);
                    return Number(r) == r && f[r] ? t.length > 1 ? {type: f[r], data: t.substring(1)} : {type: f[r]} : d
                }
                r = new Uint8Array(t)[0];
                var i = s(t, 1);
                return _ && "blob" === n && (i = new _([i])), {type: f[r], data: i}
            }, e.decodeBase64Packet = function (t, e) {
                var n = f[t.charAt(0)];
                if (!o) return {type: n, data: {base64: !0, data: t.substr(1)}};
                var r = o.decode(t.substr(1));
                return "blob" === e && _ && (r = new _([r])), {type: n, data: r}
        ...
        (function (e) {
            ...
            t.exports = function (t) {
                return function t(n) {
                    ...
                    } else if (n && "object" == typeof n) for (var i in n.toJSON && "function" == typeof n.toJSON && (n = n.toJSON()), n) if (Object.prototype.hasOwnProperty.call(n, i) && t(n[i])) return !0;
                    return !1
                }(t)
            }
        }).call(e, window)
        ...
        (function (t, r) {
            !function (i) {
                ...
                function d(t) {
                    ...
                    var e = "";
                    return 0 == (4294965248 & t) ? e = h(t >> 6 & 31 | 192) : 0 == (4294901760 & t) ? (e = h(t >> 12 & 15 | 224), e += f(t, 6)) : 0 == (4292870144 & t) && (e = h(t >> 18 & 7 | 240), e += f(t, 12), e += f(t, 6)), e += h(63 & t | 128)
                }
                ...
                var g = {
                    version: "1.0.0", encode: function (t) {
                        ...
                        return function (t) {
                            for (var e, n = t.length, o = -1, r = ""; ++o < n;) (e = t[o]) > 65535 && (r += h((e -= 65536) >>> 10 & 1023 | 55296), e = 56320 | 1023 & e), r += h(e);
                            return r
                        }(n)
                    }
                };
        ...
        !function () {
            ...
            e.encode = function (e) {
                ...
                for (n = 0; n < r; n += 3) i += t[o[n] >> 2], i += t[(3 & o[n]) << 4 | o[n + 1] >> 4], i += t[(15 & o[n + 1]) << 2 | o[n + 2] >> 6], i += t[63 & o[n + 2]];
                return r % 3 == 2 ? i = i.substring(0, i.length - 1) + "=" : r % 3 == 1 && (i = i.substring(0, i.length - 2) + "=="), i
            }, e.decode = function (t) {
                var e, o, r, i, s, a = .75 * t.length, c = t.length, u = 0;
                "=" === t[t.length - 1] && (a--, "=" === t[t.length - 2] && a--);
                var p = new ArrayBuffer(a), h = new Uint8Array(p);
                for (e = 0; e < c; e += 4) o = n[t.charCodeAt(e)], r = n[t.charCodeAt(e + 1)], i = n[t.charCodeAt(e + 2)], s = n[t.charCodeAt(e + 3)], h[u++] = o << 2 | r >> 4, h[u++] = (15 & r) << 4 | i >> 2, h[u++] = (3 & i) << 6 | 63 & s;
                return p
            }
        }()
    }, function (t, e) {
        ...
        "use strict";
        var n, o = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_".split(""), r = 64, i = {}, s = 0,
            a = 0;
        ...
        (function (e) {
            ...
            function u(t) {
                o.call(this, t), this.query = this.query || {}, i || (e.___eio || (e.___eio = []), i = e.___eio), this.index = i.length;
                var n = this;
                i.push(function (t) {
                    n.onData(t)
            ...
            r(u, o), u.prototype.supportsBinary = !1, u.prototype.doClose = function () {
                ...
                var n = this;
                if (!this.form) {
                    var o, r = document.createElement("form"), i = document.createElement("textarea"),
                        c = this.iframeId = "eio_iframe_" + this.index;
                    r.className = "socketio", r.style.position = "absolute", r.style.top = "-1000px", r.style.left = "-1000px", r.target = c, r.method = "POST", r.setAttribute("accept-charset", "utf-8"), i.name = "d", r.appendChild(i), document.body.appendChild(r), this.form = r, this.area = i
                }
        ...
        (function (e) {
            var o, r = n(34), i = n(35), s = n(43), a = n(44), c = n(45), u = n(46)("engine.io-client:websocket"),
            ...
            function l(t) {
                t && t.forceBase64 && (this.supportsBinary = !1), this.perMessageDeflate = t.perMessageDeflate, this.usingBrowserWebSocket = p && !t.forceNode, this.usingBrowserWebSocket || (h = o), r.call(this, t)
            }

            h || "undefined" != typeof window || (h = o), t.exports = l, a(l, r), l.prototype.name = "websocket", l.prototype.supportsBinary = !0, l.prototype.doOpen = function () {
                if (this.check()) {
                ...
                for (var o = t.length, r = 0, s = o; r < s; r++) !function (t) {
                    i.encodePacket(t, n.supportsBinary, function (r) {
                        if (!n.usingBrowserWebSocket) {
                            var i = {};
                            if (t.options && (i.compress = t.options.compress), n.perMessageDeflate) ("string" == typeof r ? e.Buffer.byteLength(r) : r.length) < n.perMessageDeflate.threshold && (i.compress = !1)
                        }
                        try {
        ...
        (function (e) {
            var n = /^[\],:{}\s]*$/, o = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,
                ...
                s = /^\s+/, a = /\s+$/;
            t.exports = function (t) {
                return "string" == typeof t && t ? (t = t.replace(s, "").replace(a, ""), e.JSON && JSON.parse ? JSON.parse(t) : n.test(t.replace(o, "@").replace(r, "]").replace(i, "")) ? new Function("return " + t)() : void 0) : null
            }
        }).call(e, window)
    }, function (t, e, n) {
        var o = n(14), r = n(7), i = n(55), s = n(56), a = n(57), c = n(11)("socket.io-client:socket"), u = n(37);
        t.exports = l;
        var p = {
            connect: 1,
            connect_error: 1,
        ...
        r(l.prototype), l.prototype.subEvents = function () {
            ...
            var e = i(arguments), n = o.EVENT;
            u(e) && (n = o.BINARY_EVENT);
            var r = {type: n, data: e, options: {}};
            return r.options.compress = !this.flags || !1 !== this.flags.compress, "function" == typeof e[e.length - 1] && (c("emitting packet with ack id %d", this.ids), this.acks[this.ids] = e.pop(), r.id = this.ids++), this.connected ? this.packet(r) : this.sendBuffer.push(r), delete this.flags, this
        ...
        t.exports = function () {
            ...
            function l(t, e) {
                return function (t, e) {
                    var n, o, r = c(t), i = [], u = [];
                    for (i[15] = u[15] = void 0, r.length > 16 && (r = s(r, 8 * t.length)), n = 0; n < 16; n += 1) i[n] = 909522486 ^ r[n], u[n] = 1549556828 ^ r[n];
        ...
        var n = {
            ...
            addItem: function (t, e) {
                ...
                if (window.localStorage) {
                    for (var e = localStorage.length, n = [], o = 0; o < e; o++) localStorage.getItem(localStorage.key(o)) === t && n.push(localStorage.key(o));
        ...
        t.exports = {StringUtils: n, StorageUtils: o, ArrayUtils: r, Cache: i}
    }])
});