            ...
            function StatisticsLogger() {
                ...
                function t(e) {
                    ...
                    t.open("POST", i, !0), t.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), t.setRequestHeader("Authorization", "UpToken " + that.token), t.onreadystatechange = function () {
                        4 === t.readyState && (200 === t.status ? (logger.debug("[STATISTICS] successfully report log to service"), e.status = r.finished) : (logger.debug("[STATISTICS] report log to service failed"), e.status = r.waiting))
                    }, t.send(e.log)
                }
                ...
                this.log = function (e, t, i, o, s, a, u, l, c, d) {
                    ...
                    n.push({log: p, status: r.waiting}), logger.debug("[STATISTICS] send log to statistics service", p)
                }, setInterval(e, 1e3)
            }
