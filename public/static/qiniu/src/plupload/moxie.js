...
define('moxie/file/FileInput', [
	...
	with _FileReader_ or uploaded to a service through _XMLHttpRequest_.
...
define('moxie/file/FileDrop', [
	...
	in conjunction with _Image_, preloaded in memory with _FileReader_ or uploaded to a service through 
	_XMLHttpRequest_.
	...
	function XMLHttpRequest() {
		...
		Basic.extend(this, props, {
			...
			*/
			...
			@param {String} [user] Username to use in HTTP authentication process on service-side
			@param {String} [password] Password to use in HTTP authentication process on service-side
			*/
		...
		function _doXHR(data) {
			...
			function exec(runtime) {
				...
				_xhr.bind('Load', function(e) {
					...
					if (_p('status') > 0) { // status 0 usually means that service is unreachable
						if (_upload_events_flag) {
							self.upload.dispatchEvent(e);
						}
						self.dispatchEvent(e);
					...
					_xhr.onreadystatechange = function onReadyStateChange() {
						...
						switch (_xhr.readyState) {
							...
							case 4: // XMLHttpRequest.DONE
								...
								// usually status 0 is returned when service is unreachable, but FF also fails to status 0 for 408 timeout
								if (_xhr.status === 0) {
