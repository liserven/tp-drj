...
var plupload = {
	...
	/**
	 * HTTP transport error. For example if the service produces a HTTP status other than 200.
	 *
	 * @property HTTP_ERROR
	 * @static
	 * @final
...
@param {Object} settings For detailed information about each option check documentation.
	...
	@param {String} settings.url URL of the service-side upload handler.
...
plupload.Uploader = function(options) {
	...
	*/
	...
	@param {Object} result Object with response properties.
		@param {Number} result.offset The amount of bytes the service has received so far, including this chunk.
		@param {Number} result.total The size of the file.
		@param {String} result.response The response body sent by the service.
		@param {Number} result.status The HTTP status code sent by the service.
