...
;(function (global) {
    ...
    function QiniuJsSDK() {
        ...
        function StatisticsLogger() {
            ...
            /**
             * send logs to statistics service
             *
            ...
            this.log = function (code, req_id, host, remote_ip, port, duration, up_time, bytes_sent, up_type, file_size) {
                ...
                logger.debug("[STATISTICS] send log to statistics service", log);
            };
            ...
            function send(task) {
                ...
                ajax.onreadystatechange = function () {
                    if (ajax.readyState === 4) {
                        if (ajax.status === 200) {
                            logger.debug("[STATISTICS] successfully report log to service");
                            task.status = TaskStatus.finished;
                        } else {
                            logger.debug("[STATISTICS] report log to service failed");
        ...
        this.uploader = function (op) {
            ...
            // used to send statistics log to service
