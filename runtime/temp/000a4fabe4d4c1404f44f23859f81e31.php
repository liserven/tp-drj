<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"D:\phpStudy\WWW\zgmrw\public/../application/admin\view\partner\toList.html";i:1516868756;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\layout.html";i:1516347325;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\header.html";i:1516347325;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\footer.html";i:1517209356;}*/ ?>
...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend>嘉宾管理 <a href="javascript:;" class="layui-btn layui-btn-small add">添加</a>
    ...
    <div class="layui-table-box" style="overflow: auto">
        <table class="layui-table" style="width: 100%; border: 1px solid #eee">
            ...
            <tr>
                ...
                <th data-field="type">
                    <div class="layui-table-cell"><span>公司官网</span></div>
                </th>
                <th data-field="type">
            ...
            <?php if(is_array($page) || $page instanceof \think\Collection || $page instanceof \think\Paginator): $i = 0; $__LIST__ = $page;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr data-index="0" class="tbody_content" data-id="<?php echo $vo['id']; ?>">
                    ...
                    <td>
                        <div class="layui-table-cell"><a href="http://<?php echo $vo['link_url']; ?>"><?php echo $vo['link_url']; ?></a></div>
                    </td>
                    <td>
