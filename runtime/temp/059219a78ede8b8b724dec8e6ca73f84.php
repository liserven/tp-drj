<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"D:\phpStudy\WWW\zgmrw\public/../application/home\view\doctor\detail.html";i:1517535433;s:55:"D:\phpStudy\WWW\zgmrw\application\home\view\layout.html";i:1517304201;s:55:"D:\phpStudy\WWW\zgmrw\application\home\view\header.html";i:1517534367;s:55:"D:\phpStudy\WWW\zgmrw\application\home\view\footer.html";i:1517534367;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="indexshowcontent">
    <div class="row-rotuer indexshowlogo" style="margin-top:40px;">
        <div class="messageleft">
            <ul class="doctormessage">
                <li>

                    <img width="100%" src="<?php echo $data['logo']; ?>" alt="">
                    <img class="authentication_icon" src="__ROOT__/Image/authentication_icon.png" alt="">
                    <h1><?php echo $data['name']; ?></h1>
                    <span><?php echo $data['current_post']; ?></span>
                    <button class="follow"><i></i><text>关注</text></button>
                    <p><?php echo $data['hospital']; ?></p>
                    <dd>北京市东城区金宝街88号金宝汇购物中心</dd>
                    <a>擅长：

                        <br>
                        <?php if(is_array($data['projects']) || $data['projects'] instanceof \think\Collection || $data['projects'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['projects'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <span><?php echo $vo['project']['name']; ?></span>
            ...
            <div class="doctorintroduction">
                <!-- 医师简介 -->
                <div class="doctorbrief">
                    <h3 class="verticalheader"><div></div>医师简介</h3>
                    <p class="doctorbriefmessage">
                        <?php echo $data['message']; ?>
                    </p>
                </div>
                <!-- 医师证书 -->
                <div class="doctorbrief">
                    <h3 class="verticalheader"><div></div>医师证书</h3>
                    <a class="certificate"><img src="<?php echo $data['zgz_img']; ?>" alt=""><span>医师资格证</span></a>
                    <a class="certificate"><img src="<?php echo $data['zyz_img']; ?>" alt=""><span>医师职业证</span></a>
                </div>
                <!-- 学术成果 -->
                <div class="doctorbrief achievements">
                    <h3 class="verticalheader"><div></div>学术成果</h3>
                    <p>[1]赵永辉 中医美容学.人民卫生出版社，2002.6
                    <p>[2]刘宜群.中医美容学[M].1版.北京:中国中医药出版社,2006,6:1</p>
                    <p>[3]胡长鑫.生活美容与医学美容的历史小考.医学与哲学,1992:(2):51</p>
                    <p>[4]刘宁 中医美容学.中国中医药出版,200:11:1</p></p>
                </div>
