<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\phpStudy\WWW\zgmrw\public/../application/home\view\doctor\index.html";i:1517534787;s:55:"D:\phpStudy\WWW\zgmrw\application\home\view\layout.html";i:1517304201;s:55:"D:\phpStudy\WWW\zgmrw\application\home\view\header.html";i:1517534367;s:55:"D:\phpStudy\WWW\zgmrw\application\home\view\footer.html";i:1517534367;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <a href="">
                            <ul class="col-md-3 float-left">
                                <li class="on list flipou">
                                    <img width="100%" height="164px" src="<?php echo $vo['logo']; ?>" alt="">
                                    <dt><b><?php echo $vo['name']; ?></b><span><?php echo $vo['current_post']; ?></span></dt>
                                    ...
                                    <p style="margin-top: 28px;">
                                        <?php if(is_array($vo['projects']) || $vo['projects'] instanceof \think\Collection || $vo['projects'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['projects'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                            <a href="<?php echo url('home/Doctor/commont'); ?>" target="_blank"><?php echo $v['project']['name']; ?></a>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </p>
                                </li>
                                <li class="hositry list flipou out">
                                    <a href="/doctor_detail/<?php echo $vo['id']; ?>">
                                    <h3><a href="<?php echo url('home/Doctor/commont',[ 'id'=>$vo['id'] ]); ?>" target="_blank"><?php echo $vo['name']; ?></a></h3><span><?php echo $vo['current_post']; ?></span>
                                    <div style="clear: both;"></div>
                                    <p class="s1"><a href="<?php echo url('home/Doctor/commont'); ?>" target="_blank"><?php echo $vo['hospital']; ?></a></p>
                                    <p class="s2"><a href="<?php echo url('home/Doctor/commont'); ?>" target="_blank"><?php echo $vo['message']; ?></a></p>
