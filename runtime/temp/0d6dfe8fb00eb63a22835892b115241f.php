...
<div  style="margin: 100px 0 40px 210px;">
    <fieldset class="layui-elem-field layui-field-title">
        <legend>修改客户 <a href="<?php echo url('index/Kehu/toList'); ?>" class="layui-btn layui-btn-small">客户列表</a> </legend>
    </fieldset>
    <form class="layui-form" id="add_vote" method="post" action="<?php echo url('index/Kehu/doEdit'); ?>">
        <div class="layui-form-item text-center">
            <label class="layui-form-label">姓名</label>
            <div class="layui-input-inline">
                <input type="text" name="name" lay-verify="required"  autocomplete="off" value="<?php echo $data['name']; ?>" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="phone" lay-verify="phone"  value="<?php echo $data['phone']; ?>" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">微信号</label>
            <div class="layui-input-inline">
                <input type="text" name="wx" value="<?php echo $data['wx']; ?>" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">QQ号</label>
            <div class="layui-input-inline">
                <input type="text" name="qq" value="<?php echo $data['qq']; ?>" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">备注</label>
            <div class="layui-input-block">
                <textarea name="message" id="message" class=""><?php echo $data['message']; ?></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="status" lay-verify="required">
                    <option value="1" <?php echo $data['status']==1?'selected' : ''; ?>>潜在客户</option>
                    <option value="2" <?php echo $data['status']==2?'selected' : ''; ?>>已确定可签单</option>
                </select>
            </div>
        </div>
        <div class="layui-form-item">
