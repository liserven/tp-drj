<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"D:\phpStudy\WWW\zgmrw\public/../application/admin\view\hospital\toList.html";i:1517215968;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\layout.html";i:1516347325;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\header.html";i:1516347325;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\footer.html";i:1517209356;}*/ ?>
...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend>医院列表 <a href="javascript:;" class="layui-btn layui-btn-small add">添加</a>
        ...
        <table class="layui-table" style="width: 100%; border: 1px solid #eee">
          <colgroup>
            ...
            <tr>
                ...
                <th data-field="type">
                    <div class="layui-table-cell"><span>服务类型</span></div>
                </th>
                <th data-field="type">
                    <div class="layui-table-cell"><span>资本类型</span></div>
                </th>
                <th>
                ...
                <th>
                    <div class="layui-table-cell"><span>擅长项目</span></div>
                </th>
            ...
            <tr data-index="0" class="tbody_content" data-id="<?php echo $vo['id']; ?>">
                ...
                <td>
                    <div class="layui-table-cell"><?php echo $vo['diqu']; ?></div>
                </td>


                <td>
                    <div class="layui-table-cell"><?php echo $vo['stype']; ?></div>
                </td>



                <td>
                    <div class="layui-table-cell"><?php echo $vo['capital_type']; ?></div>
                </td>
