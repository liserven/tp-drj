<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"D:\phpStudy\WWW\drj\public/../application/admin\view\building\doedit.html";i:1525072108;s:54:"D:\phpStudy\WWW\drj\application\admin\view\layout.html";i:1519356432;s:54:"D:\phpStudy\WWW\drj\application\admin\view\header.html";i:1519809078;s:54:"D:\phpStudy\WWW\drj\application\admin\view\footer.html";i:1523864180;}*/ ?>
            ...
            <div class="layui-input-block">
                <?php if(is_array($deploy) || $deploy instanceof \think\Collection || $deploy instanceof \think\Paginator): $i = 0; $__LIST__ = $deploy;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <input name="deploy[]" title="<?php echo $vo['name']; ?>" type="checkbox"
                           <?php  if( in_array( $vo['id'], $deploys) ) {  echo 'checked';} ?>
