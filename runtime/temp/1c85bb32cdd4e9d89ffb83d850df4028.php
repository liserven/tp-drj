<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"D:\phpStudy\WWW\zgmrw\public/../application/admin\view\meeting\tolist.html";i:1516929431;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\layout.html";i:1516347325;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\header.html";i:1516347325;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\footer.html";i:1517209356;}*/ ?>
...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend>会议管理 <a href="javascript:;" class="layui-btn layui-btn-small add">添加会议</a>
        ...
        <table class="layui-table" style="width: 100%; border: 1px solid #eee">
          <colgroup>
            ...
            <tr>
                ...
                <th data-field="type">
                    <div class="layui-table-cell"><span>海报</span></div>
                </th>
                <th data-field="type">
                    <div class="layui-table-cell"><span>举办地点</span></div>
                </th>
                <th data-field="type">
                    <div class="layui-table-cell"><span>是否收费</span></div>
                </th>
                <th data-field="type">
                    <div class="layui-table-cell"><span>会议议程</span></div>
                </th>
                 <th data-field="type">
                    <div class="layui-table-cell"><span>邀请嘉宾</span></div>
                </th>
                <th data-field="type">
                    <div class="layui-table-cell"><span>合作伙伴</span></div>
                </th>
                <th>
                    <div class="layui-table-cell"><span>开始时间</span></div>
                </th>
                <th>
            ...
            <tr data-index="0" class="tbody_content" data-id="<?php echo $vo['id']; ?>">
                ...
                <td>
                    <div class="layui-table-cell" style="height:50px"><img src="<?php echo $vo['img']; ?>" alt=""></div>
                </td>
                <td>
                    <div class="layui-table-cell"><?php echo $vo['city']; ?></div>
                </td>
                <td>
                    <div class="layui-table-cell"><?php echo $vo['is_charge']; ?></div>
                </td>
                <td>
                    <div class="layui-table-cell"><a href="javascript:;">查看详情</a></div>
                </td>
                <td>
                    <div class="layui-table-cell"><a href="javascript:;">查看详情</a></div>
                </td>
                ...
                <td>
                    <div class="layui-table-cell"><?php echo $vo['over_time']; ?></div>
                </td>
                <td>
                ...
                <td>
                    <div class="layui-table-cell">
                        ...
                        <a class="layui-btn layui-btn-xs see-detail">查看详情</a>
                    </div>
                </td>
            </tr>
