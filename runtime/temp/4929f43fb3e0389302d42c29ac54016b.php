<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\phpStudy\WWW\zgmrw\public/../application/admin\view\index\index.html";i:1516761499;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\layout.html";i:1516347325;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\header.html";i:1516347325;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\footer.html";i:1517209356;}*/ ?>
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child lsy-col-offset2" style="text-align: center;">
                            <?php if(is_array($vo['data']) || $vo['data'] instanceof \think\Collection || $vo['data'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                <dd><a href="javascript:;" href-url="<?php echo $v['url']; ?>"><?php echo $v['title']; ?></a></dd>
