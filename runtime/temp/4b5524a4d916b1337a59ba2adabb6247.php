<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"D:\phpStudy\WWW\drj\public/../application/admin\view\building\lookup.html";i:1523879667;s:54:"D:\phpStudy\WWW\drj\application\admin\view\layout.html";i:1519356432;s:54:"D:\phpStudy\WWW\drj\application\admin\view\header.html";i:1519809078;s:54:"D:\phpStudy\WWW\drj\application\admin\view\footer.html";i:1523864180;}*/ ?>
    ...
    <div class="layui-table-box">
        <table class="layui-table" style="width: 100%; border: 1px solid #eee">
            ...
            <tbody class="">
                    ...
                    <td>
                        <div class="layui-table-cell"><?php echo $list['g_name']; ?></div>
                    </td>
                    <td>
                        <div class="layui-table-cell"><?php echo $list['g_column']; ?></div>
                    </td>
                    <td>
                        <div class="layui-table-cell"><?php echo $list['g_material']; ?></div>
                    </td>
                    <td>
                        <div class="layui-table-cell"><?php echo $list['order']; ?></div>
                    </td>
                    ...
                    <?php endif; ?>
                    <td>
                        <div class="layui-table-cell"><img src="<?php echo $list['g_img']; ?>?imageView2/1/w/50/h/50"></div>
                    </td>
                    <td>
                        <div class="layui-table-cell"><?php echo $list['create_at']; ?></div>
                    </td>

                    <td>
                        <div class="layui-table-cell"><?php echo $list['update_at']; ?></div>
                    </td>
