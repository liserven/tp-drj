<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"D:\phpStudy\WWW\zgmrw\public/../application/admin\view\service\toList.html";i:1516762596;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\layout.html";i:1516347325;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\header.html";i:1516347325;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\footer.html";i:1517209356;}*/ ?>
...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend>服务类型管理 <a href="javascript:;" class="layui-btn layui-btn-small add">添加</a>
        ...
        <table class="layui-table" style="width: 100%; border: 1px solid #eee">
            ...
            <tr>
                ...
                <th data-field="1" data-unresize="true">
                    <div class="layui-table-cell laytable-cell-1-1 laytable-cell-checkbox">
                        <input name="layTableCheckbox" lay-skin="primary" lay-filter="layTableAllChoose"
                               type="checkbox">
            ...
            <?php if(is_array($page) || $page instanceof \think\Collection || $page instanceof \think\Paginator): $i = 0; $__LIST__ = $page;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr data-index="0" class="tbody_content" data-id="<?php echo $vo['id']; ?>">
                    ...
                    <td>
                        <div class="layui-table-cell"><?php echo $vo['pType']['type']; ?></div>
                    </td>
                    <td>
                        <div class="layui-table-cell"><input value='<?php echo $vo['order']; ?>' class='layui-input edit-order'
