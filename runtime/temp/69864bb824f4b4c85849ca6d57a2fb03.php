<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\phpStudy\WWW\zgmrw\public/../application/admin\view\user\tolist.html";i:1516347335;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\layout.html";i:1516347325;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\header.html";i:1516347325;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\footer.html";i:1517209356;}*/ ?>
...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend>用户列表 <a href="<?php echo url('user/add'); ?>" class="layui-btn layui-btn-small">添加员工</a>
    ...
    <div class="layui-table-box">
        <table class="layui-table" style="width: 100%; border: 1px solid #eee">
          <colgroup>
            ...
            <tr data-index="0" class="tbody_content" data-id="<?php echo $vo['au_id']; ?>">
                <td >
                ...
                <td>
                    <div class="layui-table-cell"><?php echo $vo['au_id']; ?></div>
                </td>
                <td>
                    <div class="layui-table-cell"><?php echo $vo['au_nickname']; ?></div>
                </td>
                <td>
                    <div class="layui-table-cell"><?php echo $vo['au_iphone']; ?></div>
                </td>
                <td>
                    <div class="layui-table-cell" style="height:55px;">
                        <img src="<?php echo $vo['au_logo']; ?>?imageView2/1/w/50/h/50" alt="">
                    </div>
                </td>
                <td >
                ...
                <td data-id="1">
                    <div class="layui-table-cell">
                        <input type="checkbox" lay-filter="eidt_status" lay-skin="switch" lay-text="启用|停用"
                               type-d="<?php echo $vo['au_status']==1?2:1; ?>" <?php echo $vo['au_status']==1?'checked' :''; ?>>
                    </div>
                </td>
                <td>
                    <div class="layui-table-cell"><?php echo date('Y-m-d H:i:s',$vo['au_pre_time']); ?></div>
                </td>
                <td>
                    <div class="layui-table-cell"><?php echo $vo['au_ctime']; ?></div>
                </td>
                <td>
                    <div class="layui-table-cell"><?php echo $vo['au_utime']; ?></div>
                </td>
                <td>
                    <div class="layui-table-cell">
            ...
            <tfoot>
                <tr>
                    <td colspan="13"><?php echo $userList->render();; ?></td>
                </tr>
            </tfoot>
        </table>
