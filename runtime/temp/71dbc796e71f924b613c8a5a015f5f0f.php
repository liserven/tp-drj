<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"D:\phpStudy\WWW\lsy\public/../application/admin\view\duty\doadd.html";i:1515422386;s:54:"D:\phpStudy\WWW\lsy\application\admin\view\layout.html";i:1515217144;s:54:"D:\phpStudy\WWW\lsy\application\admin\view\header.html";i:1515422385;s:54:"D:\phpStudy\WWW\lsy\application\admin\view\footer.html";i:1515217144;}*/ ?>
                    ...
                    <fieldset class="layui-elem-field">
                        ...
                        <div class="layui-field-box">
                            <?php if(is_array($vo['actions']) || $vo['actions'] instanceof \think\Collection || $vo['actions'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['actions'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                <input type="checkbox" value="<?php echo $v['ad_id']; ?>" name="actions[]" title="<?php echo $v['ad_topic']; ?>" lay-skin="primary">
