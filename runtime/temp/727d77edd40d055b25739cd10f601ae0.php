<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"D:\phpStudy\WWW\drhome\public/../application/admin\view\duty\tolist.html";i:1525422713;s:57:"D:\phpStudy\WWW\drhome\application\admin\view\layout.html";i:1525422713;s:57:"D:\phpStudy\WWW\drhome\application\admin\view\header.html";i:1525422713;s:57:"D:\phpStudy\WWW\drhome\application\admin\view\footer.html";i:1525422713;}*/ ?>
...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend>角色列表 <a href="javascript:;" class="layui-btn layui-btn-small add">添加角色</a>
        ...
        <table class="layui-table" style="width: 100%; border: 1px solid #eee">
          <colgroup>
            ...
            <tr>
                ...
                <th data-field="type">
                    <div class="layui-table-cell"><span>所属管理员</span></div>
                </th>
                <th>
            ...
            <tr data-index="0" class="tbody_content" data-id="<?php echo $vo['dd_id']; ?>">
                <td >
                ...
                <td>
                    <div class="layui-table-cell"><?php echo $vo['dd_id']; ?></div>
                </td>
                <td>
                    <div class="layui-table-cell"><?php echo $vo['dd_name']; ?></div>
                </td>
                <td>
                    <div class="layui-table-cell"><a href="javascript:;" class="success-color">查看详情</a></div>
                </td>
                <td data-id="1">
                    <div class="layui-table-cell">
                        <input type="checkbox" lay-filter="eidt_status" lay-skin="switch" lay-text="启用|停用"
                               type-d="<?php echo $vo['dd_status']==1?2:1; ?>" <?php echo $vo['dd_status']==1?'checked' :''; ?>>
                    </div>
                </td>
                <td>
                    <div class="layui-table-cell"><?php echo $vo['dd_ctime']; ?></div>
                </td>
                <td>
                    <div class="layui-table-cell"><?php echo $vo['dd_utime']; ?></div>
                </td>
                <td>
                    <div class="layui-table-cell">
