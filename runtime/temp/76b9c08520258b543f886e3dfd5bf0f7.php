<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"D:\phpStudy\WWW\drj\public/../application/admin\view\cigdp\tolist.html";i:1520997823;s:54:"D:\phpStudy\WWW\drj\application\admin\view\layout.html";i:1519356432;s:54:"D:\phpStudy\WWW\drj\application\admin\view\header.html";i:1519809078;s:54:"D:\phpStudy\WWW\drj\application\admin\view\footer.html";i:1521108885;}*/ ?>
    ...
    <div class="layui-table-box">
        <table class="layui-table" style="width: 100%; border: 1px solid #eee">
            ...
            <tr>
                ...
                <th data-field="type">
                    <div class="layui-table-cell"><span>GDP(亿元)</span></div>
                </th>
            ...
            <?php if(is_array($page) || $page instanceof \think\Collection || $page instanceof \think\Paginator): $i = 0; $__LIST__ = $page;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr data-index="0" class="tbody_content" data-id="<?php echo $vo['id']; ?>">
                    ...
                    <td>
                        <div class="layui-table-cell"><?php echo $vo['gdp']; ?></div>
                    </td>
                    ...
                    <td>
                        <div class="layui-table-cell"><?php echo data("Y-m-d",$vo['create_at']); ?></div>
                    </td>
                    <td>
                    ...
                    <td>
                        <div class="layui-table-cell">
                            <a class="layui-btn layui-btn-xs edit">查看报告</a>
