<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:75:"/www/wwwroot/kx.lsybk.com/public/../application/index/view/plan/doedit.html";i:1513523121;s:70:"/www/wwwroot/kx.lsybk.com/public/../application/index/view/layout.html";i:1513523121;s:72:"/www/wwwroot/kx.lsybk.com/public/../application/index/view/./header.html";i:1513523121;s:72:"/www/wwwroot/kx.lsybk.com/public/../application/index/view/./lefter.html";i:1513523121;s:72:"/www/wwwroot/kx.lsybk.com/public/../application/index/view/./footer.html";i:1513523121;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div  style="margin: 100px 0 40px 210px;overflow: auto">
    ...
    <form class="layui-form" id="add_vote" method="post" action="<?php echo url('index/Plan/doEdit'); ?>">
        <div class="layui-form-item text-center">
            <label class="layui-form-label">标题</label>
            <div class="layui-input-inline">
                <input type="text" name="topic" lay-verify="required" autocomplete="off" placeholder="起个可爱的标题吧" value="<?php echo $data['topic']; ?>" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">计划详情</label>
            <div class="layui-input-block">
                <textarea name="content" id="content" placeholder="请输入内容" class=""><?php echo $data['content']; ?></textarea>
            </div>
        </div>
