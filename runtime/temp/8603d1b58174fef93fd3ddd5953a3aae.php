            ...
            <div class="industry-container float-left">
                <div class="xobbox">
                    <ul class="col-md-5 swiper-container float-left padding-none" style="width: 39.5%;">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide lunindex">
                                <a href="#"><img width="100%" height="129px" src="__ROOT__/Image/swiper1-logo0.png" alt=""></a>
                                <div class="imagetitle">dhaosdhoaish</div>
                            </div>
                        </div>
                    </ul>
                    <ul class="col-md-7 swiper-container float-right padding-none">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide lunindex">
                                <a href="#"><img width="100%" height="270px" src="__ROOT__/Image/swiper1-logo0.png" alt=""></a>
                                <div class="imagetitle">dhaosdhoaish</div>
                            </div>
                        </div>
                    </ul>
                ...
                <ul class="dynamic-commit">
                    <li>
                        <a href="<?php echo url('home/Policies/tonull'); ?>" target="_blank" class="float-left"><img src="__ROOT__/Image/dynamic-commit-image.png" alt=""></a>
                        <dd class="float-left">
                            <h3><a href="<?php echo url('home/Policies/tonull'); ?>" target="_blank">上门美容持续火爆！美容总监获1500万美元A轮融资</a></h3>
                            <p><span>美容网</span><a>2017-10-02</a></p>
                        </dd>
                    </li>
                    <li>
                        <a class="float-left"><img src="__ROOT__/Image/dynamic-commit-image.png" alt=""></a>
                        <dd class="float-left">
                            <h3><a href="">上门美容持续火爆！美容总监获1500万美元A轮融资</a></h3>
                            <p><span>美容网</span><a>2017-10-02</a></p>
                        </dd>
                    </li>
                    <li>
