<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"D:\phpStudy\WWW\drhome\public/../application/admin\view\bargain\tolist.html";i:1525761276;s:57:"D:\phpStudy\WWW\drhome\application\admin\view\layout.html";i:1525422713;s:57:"D:\phpStudy\WWW\drhome\application\admin\view\header.html";i:1525942363;s:57:"D:\phpStudy\WWW\drhome\application\admin\view\footer.html";i:1525422713;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <table class="layui-table" style="width: 100%; border: 1px solid #eee">
            ...
            <tr>
                ...
                <th data-field="createdTime">
                    <div class="layui-table-cell"><span>砍价总金额</span></div>
                </th>

                <th data-field="11">
                    <div class="layui-table-cell" align="center"><span>砍价人数量</span></div>
                </th>
                <th data-field="11">
                    <div class="layui-table-cell" align="center"><span>砍价说明</span></div>
                </th>
                <th data-field="11">
            ...
            <?php if(is_array($page) || $page instanceof \think\Collection || $page instanceof \think\Paginator): $i = 0; $__LIST__ = $page;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr data-index="0" class="tbody_content" data-id="<?php echo $vo['id']; ?>">
                    ...
                    <td>
                        <div class="layui-table-cell"><?php echo $vo['b_money']; ?></div>
                    </td>
                    <td>
                        <div class="layui-table-cell"><?php echo $vo['b_number']; ?></div>
                    </td>
                    <td>
                        <div class="layui-table-cell"><?php echo $vo['b_content']; ?></div>
                    </td>
                    <td>
