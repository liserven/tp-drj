<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"D:\phpStudy\WWW\drj\public/../application/admin\view\building\order.html";i:1519979358;s:54:"D:\phpStudy\WWW\drj\application\admin\view\layout.html";i:1519356432;s:54:"D:\phpStudy\WWW\drj\application\admin\view\header.html";i:1519809078;s:54:"D:\phpStudy\WWW\drj\application\admin\view\footer.html";i:1519356432;}*/ ?>
...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend>建材列表 <a href="javascript:;" class="layui-btn layui-btn-small add">订单列表</a>
    ...
    <div class="layui-table-box">
        <table class="layui-table" style="width: 100%; border: 1px solid #eee">
            ...
            <tr>
                ...
                <th data-field="type">
                    <div class="layui-table-cell"><span>产品信息</span></div>
                </th>
                <th data-field="modifiedTime">
                    <div class="layui-table-cell"><span>物流信息</span></div>
                </th>
            ...
            <?php if(is_array($page) || $page instanceof \think\Collection || $page instanceof \think\Paginator): $i = 0; $__LIST__ = $page;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr data-index="0" class="tbody_content" data-id="<?php echo $vo['g_id']; ?>">
                    <td >
                    ...
                    <td>
                        <div class="layui-table-cell"><?php echo $vo['g_id']; ?></div>
                    </td>
                    <td>
                        <div class="layui-table-cell"><?php echo $vo['g_name']; ?></div>
                    </td>
                    <td>
                        <div class="layui-table-cell"><?php echo $vo['g_f_f_id']; ?></div>
                    </td>
