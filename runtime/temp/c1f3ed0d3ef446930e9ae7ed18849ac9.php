<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"D:\phpStudy\WWW\zgmrw\public/../application/admin\view\news\doadd.html";i:1517536935;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\layout.html";i:1516347325;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\header.html";i:1516347325;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\footer.html";i:1517209356;}*/ ?>
    ...
    <form class="layui-form" method="post" style="padding:0 0 25px 50px; " enctype="multipart/form-data">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="one_sort" lay-verify="" lay-filter="sort">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="sort_id" lay-verify="" class="two-sort">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-col-md3">
                <input type="text" name="label" lay-verify="required" id="label-input" placeholder="请输入内容来源 比如:原创" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-col-md3">
                <?php if(is_array($hotLabel) || $hotLabel instanceof \think\Collection || $hotLabel instanceof \think\Paginator): $i = 0; $__LIST__ = $hotLabel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <a href="javascript:;" style="height: 35px; line-height: 35px;" class="label-list"><span class="layui-badge layui-bg-gray"><?php echo $vo['name']; ?></span></a>,
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-col-md3">
                ...
                <img src=""  id="yl_logo"/>
                <input type="hidden" name="sm_img" id="logo_img">
            </div>
        </div>
        <div class="layui-form-item">
