<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:75:"/www/wwwroot/kx.lsybk.com/public/../application/index/view/kehu/tolist.html";i:1513523121;s:70:"/www/wwwroot/kx.lsybk.com/public/../application/index/view/layout.html";i:1513523121;s:72:"/www/wwwroot/kx.lsybk.com/public/../application/index/view/./header.html";i:1513523121;s:72:"/www/wwwroot/kx.lsybk.com/public/../application/index/view/./lefter.html";i:1513523121;s:72:"/www/wwwroot/kx.lsybk.com/public/../application/index/view/./footer.html";i:1513523121;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div  style="margin: 100px 0 0 210px;">
    ...
    <fieldset class="layui-elem-field layui-field-title" style="margin-bottom: 0;">
        <legend>客户列表 <a href="<?php echo url('index/Kehu/doAdd'); ?>" class="layui-btn layui-btn-small">添加客户</a> </legend>
    </fieldset>
    ...
    <form action="" style="text-align: center">
        <div class="layui-input-inline">
            <input type="text" name="seach" lay-verify="required" autocomplete="off" placeholder="请输入客户手机号" class="layui-input">
        </div>
    ...
    <table class="layui-table">
        ...
        <?php if(is_array($page) || $page instanceof \think\Collection || $page instanceof \think\Paginator): $i = 0; $__LIST__ = $page;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <tr>
                ...
                <td><span class="<?php echo $vo['status']=='1'?'layui-badge' : 'layui-badge layui-bg-blue'; ?>"><?php echo getKehuStatus($vo['status']); ?></span></td>
                <td>
                    <a href="javascript:;" class="c-success get-detail-message" data-id="<?php echo $vo['id']; ?>">查看详情</a>
                    <div style="display: none"><div class="message-detail"><?php echo $vo['message']; ?></div></div>
                </td>
                <td><?php echo $vo['create_at']; ?></td>
                <td><?php echo $vo['update_at']; ?></td>
                <td>
                    <a href="<?php echo url('index/Kehu/doEdit',array('id'=>$vo['id'])); ?>" class="layui-btn  layui-btn-xs layui-btn-danger layui-btn-mini">编辑</a>
                    <a href="javascript:;" class="layui-btn  layui-btn-xs layui-btn-danger layui-btn-mini doDel" data_id="<?php echo $vo['id']; ?>" module="Kehu">删除</a>
                </td>
            </tr>
        <?php endforeach; endif; else: echo "" ;endif; ?>
        <tr>
