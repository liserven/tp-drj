<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"D:\phpStudy\WWW\lsy\public/../application/admin\view\prohibit\doadd.html";i:1515549628;s:54:"D:\phpStudy\WWW\lsy\application\admin\view\layout.html";i:1515546977;s:54:"D:\phpStudy\WWW\lsy\application\admin\view\header.html";i:1515546977;s:54:"D:\phpStudy\WWW\lsy\application\admin\view\footer.html";i:1515546978;}*/ ?>
    ...
    <form class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="text"  lay-verify="required" placeholder="请输入标题" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="replace"  placeholder="请输入替换内容" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
