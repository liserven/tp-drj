<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"D:\phpStudy\WWW\zgmrw\public/../application/home\view\policies\toList.html";i:1517395239;s:55:"D:\phpStudy\WWW\zgmrw\application\home\view\layout.html";i:1517304201;s:55:"D:\phpStudy\WWW\zgmrw\application\home\view\header.html";i:1517566734;s:55:"D:\phpStudy\WWW\zgmrw\application\home\view\footer.html";i:1517566734;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="indexshowcontent">
    <div class="row-rotuer indexshowlogo">
        <div class="messageleft margin80">
            <ul class="policiecontent">
                <li>
                    <dt>
                        最新<span>政策</span>
                    </dt>
                    <div class="zc-box">
                        <?php if(is_array($zc) || $zc instanceof \think\Collection || $zc instanceof \think\Paginator): $i = 0; $__LIST__ = $zc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <dd><a href="<?php echo url('home/Policies/tonull'); ?>" target="_blank"><?php echo $vo['title']; ?></a><span><?php echo $vo['create_at']; ?></span></dd>
                ...
                <div style="height: 20px;background-color: rgb(250, 250, 250);"></div>
                <li class="margin80">
                    <dt>
                        最新<span>法规</span></dt>
                    <div class="fg-box">
                        <?php if(is_array($fg) || $fg instanceof \think\Collection || $fg instanceof \think\Paginator): $i = 0; $__LIST__ = $fg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <dd><a href=""><?php echo $vo['title']; ?></a><span><?php echo $vo['create_at']; ?></span></dd>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                    <div class="flip">
                        <?php echo $fgPageHtml; ?>
