<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\phpStudy\WWW\zgmrw\public/../application/admin\view\news\tolist.html";i:1516347329;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\layout.html";i:1516347325;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\header.html";i:1516347325;s:56:"D:\phpStudy\WWW\zgmrw\application\admin\view\footer.html";i:1517209356;}*/ ?>
        ...
        <table class="layui-table" style="width: 100%; border: 1px solid #eee">
          <colgroup>
            ...
            <tr>
                ...
                <th>
                    <div class="layui-table-cell"><span>是否推送头条</span></div>
                </th>
                <th data-field="createdTime">
                    <div class="layui-table-cell"><span>是否置顶</span></div>
                </th>
                <th data-field="modifiedTime">
                    <div class="layui-table-cell"><span>是否允许评论</span></div>
                </th>
                <th data-field="modifiedTime">
                    <div class="layui-table-cell"><span>审核状态</span></div>
                </th>
                <th data-field="modifiedTime">
                    <div class="layui-table-cell"><span>上线状态</span></div>
                </th>
                <th data-field="modifiedTime">
            ...
            <tr data-index="0" class="tbody_content" data-id="<?php echo $vo['id']; ?>">
                ...
                <td>
                    <div class="layui-table-cell"><?php echo $vo['sm_title']; ?></div>
                </td>
                <td>
                    <div class="layui-table-cell" style="height:50px"><img src="<?php echo $vo['sm_img']; ?>" alt=""></div>
                </td>
                <td>
                ...
                <td data-id="1">
                    <div class="layui-table-cell">
                        <input type="checkbox" lay-filter="eidt_status" lay-skin="switch" lay-text="头条|否"
                               type-d="<?php echo $vo['is_hot']==1?2:1; ?>" <?php echo $vo['is_hot']==1?'checked' :''; ?>>
                    </div>
                </td>
                <td data-id="1">
                    <div class="layui-table-cell">
                        <input type="checkbox" lay-filter="eidt_status" lay-skin="switch" lay-text="置顶|否"
                               type-d="<?php echo $vo['is_top']==1?2:1; ?>" <?php echo $vo['is_top']==1?'checked' :''; ?>>
                    </div>
                </td>
                <td data-id="1">
                    <div class="layui-table-cell">
                        <input type="checkbox" lay-filter="eidt_status" lay-skin="switch" lay-text="允许|禁止"
                               type-d="<?php echo $vo['is_comment']==1?2:1; ?>" <?php echo $vo['is_comment']==1?'checked' :''; ?>>
                    </div>
                </td>
                <td data-id="1">
                    <div class="layui-table-cell">
                        <input type="checkbox" lay-filter="eidt_status" lay-skin="switch" lay-text="已审|待审"
                               type-d="<?php echo $vo['is_comment']==1?2:1; ?>" <?php echo $vo['is_comment']==1?'checked' :''; ?>>
                    </div>
                </td>
                <td data-id="1">
                    <div class="layui-table-cell">
                        <input type="checkbox" lay-filter="eidt_status" lay-skin="switch" lay-text="已发|待发"
                               type-d="<?php echo $vo['is_comment']==1?2:1; ?>" <?php echo $vo['is_comment']==1?'checked' :''; ?>>
                    </div>
                </td>
                <td>
